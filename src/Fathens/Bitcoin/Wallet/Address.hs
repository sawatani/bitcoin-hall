...
prefixP2PKH False = AddressPrefix {
  isTest = False
, symbols = ["1"]
, prefix = BS.singleton 0x00
, suffix = BS.empty
}
prefixP2PKH True = AddressPrefix {
  isTest = True
, symbols = ["m", "n"]
...
prefixP2SH False = AddressPrefix {
  isTest = False
, symbols = ["3"]
, prefix = BS.singleton 0x05
, suffix = BS.empty
}
prefixP2SH True = AddressPrefix {
  isTest = True
, symbols = ["2"]
...
prefixPRV False = AddressPrefix {
  isTest = False
, symbols = ["5"]
, prefix = BS.singleton 0x80
, suffix = BS.empty
}
prefixPRV True = AddressPrefix {
  isTest = True
, symbols = ["9"]
...
prefixCPRV False = AddressPrefix {
  isTest = False
, symbols = ["K", "L"]
, prefix = BS.singleton 0x80
, suffix = BS.singleton 0x01
}
prefixCPRV True = AddressPrefix {
  isTest = True
, symbols = ["c"]
, prefix = BS.singleton 0xef
, suffix = BS.singleton 0x01
...
prefixXPUB False = AddressPrefix {
  isTest = False
, symbols = ["xpub"]
, prefix = BS.pack [0x04, 0x88, 0xb2, 0x1e]
, suffix = BS.empty
}
prefixXPUB True = AddressPrefix {
  isTest = True
, symbols = ["tpub"]
...
prefixXPRV False = AddressPrefix {
  isTest = False
, symbols = ["xprv"]
, prefix = BS.pack [0x04, 0x88, 0xad, 0xe4]
, suffix = BS.empty
}
prefixXPRV True = AddressPrefix {
  isTest = True
, symbols = ["tprv"]
